                        ...
                        <td className="py-2.5 px-3 text-right">
                          <div className="inline-flex items-center gap-1.5 justify-end">
                            ...
                            {canDelete && (
                              <button
                                onClick={() => {
                                  if (window.confirm(`Decommission Asset ${asset.asset_id}?\n\nThis will permanently remove ${asset.asset_id} from live fleet monitoring.`)) {
                                    onDeleteAsset?.(asset.asset_id);
                                  }
                                }}
                                className="p-1 bg-white hover:bg-rose-50 border border-slate-300 hover:border-rose-400 text-slate-500 hover:text-rose-600 transition-colors"
                                title={`Decommission ${asset.asset_id} (Manager Role)`}
                              >
